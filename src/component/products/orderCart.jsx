...
console.log(items)
  ...
  return (
    <div className='h-screen relative'>
        <div className='absolute z-[-10] top-0 flex flex-col justify-center items-center w-full bg-zinc-700'>
        <img src='https://i.ibb.co/xHLcrv8/Pngtree-cat-claw-coffee-logo-4363875.png' className='h-screen opacity-70' />
        </div>
    ...
    <button className='bg-cyan-500 text-lg p-2 mx-20 w-60 rounded-xl float-right' onClick={()=>handleOrder()}>Paid and Order</button>
       {showWaitTime ? 
       <div>
        {timerCheck ?
        <div className='absolute left-20 p-3 text-white rounded-lg'>
    ...
    : <div className='flex flex-col justify-center items-start h-4/5 mx-20'>
        <BsCart4 className='text-white text-5xl'/>
        <p className='text-white text-5xl drop-shadow-lg mx'>Your Cart is Empty</p>
    </div> }
    </div>
  )
}
