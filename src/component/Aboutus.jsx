...
export const Aboutus = () => {
  return (
    ...
    <NavLink to='/' className='absolute left-5 top-2'><TiArrowBack className='text-white text-5xl'/></NavLink>
      <div className='flex flex-col justify- items-center p-4 h-screen text-white bg-zinc-800'>
        ...
        <div className='text-center my-2 mx-2 p-5'>
            ...
            <p className='text-center text-lg '>Welcome to our Brew Box coffee shop, where the aroma of freshly roasted beans fills the air and the sound of steaming milk is music to your ears. Our mission is to provide our customers with a warm and inviting atmosphere where they can relax, socialize, and enjoy some of the finest coffee beverages around.
